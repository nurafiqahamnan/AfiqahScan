package com.example.lenovo.afiqahscan;
...
// com.google.zxing.client.android.SCANintent
...
//on catch, show the download dialog
    ...
    public void scanQR(View v) {
        try {
//start the scanning activity from
...
//get the extras that are returned from the intent
                ...
                Toast toast = Toast
                        .makeText(this, "Content:" + contents + " Format:" + format,
                                Toast.LENGTH_LONG);
                toast.show();
            }
        }
